...
for i in range(5*f):
    teachers[i].pcontact += classrooms[i%len(classrooms)] # every teacher have only one classroom but every 
    k = 0
...
casesl   = [1]# newcases in a list for the plot
casest   = [1]# cases in a list for the plot
deathsl  = [0]# newdeaths in a list for the plot
deathst  = [0]# deaths in a list for the plot
recoverl = [0]# newrecovery in a list for the plot
recovert = [0]# recovery in a list for the plot
popl     = [pop]# the population number -1 if someone dies
